...
async function displayEditForm(listItem, eventID) {
    ...
    for (const username of usernames) {
        ...
        newUsername.type = 'radio';
        newUsername.id = username;
        ...
        newUsernameLabel.textContent = username; //IconDescription
        newUsernameLabel.for = username;

        usernameGroup.appendChild(newUsername);
        usernameGroup.appendChild(newUsernameLabel);
    }
    ...
    // usernameSelect.value = defaultUsername;
    ...
    editEventForm.appendChild(usernameGroup);
    editEventForm.appendChild(document.createElement('br'));
    ...
    updateBtn.addEventListener('click', function () {
        const usernameOptions = document.getElementsByClassName('username');
        ...
        console.log('updateEvent: ', eventNameInput.value, Number(durationInput.value), detailsInput.value, selectedUsername);
        updateEvent(listItem, eventID, eventNameInput.value, Number(durationInput.value), detailsInput.value, selectedUsername);
        // updateEvent(listItem, eventID, eventNameInput.value, eventDateTimeInput.value, Number(durationInput.value), detailsInput.value, selectedUsername);
    })
